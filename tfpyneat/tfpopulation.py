...
class TFPopulation:
    ...
    def __init__(self, size_in: int, size_out: int, fitness_criterion, size_pop: int = 50):
        ...
        self.species: List[List[TFGenome]] = []
    ...
    def set_best(self):
        ...
        best_player: TFGenome = best_species.genomes[-1]
    ...
    def natural_selection(self):
        """
        Runs the current generation of genomes and prepares the next
        """
